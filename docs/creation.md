...
**Success / HTTP `200`:** 
```json
{"username":"Unpredictable","creation":1505683107,"http_status_code":200}
```
...
- have had their name history cleared to appear like a giftcode snipe (e.g `Unpredictable` or `Foxzes`)
